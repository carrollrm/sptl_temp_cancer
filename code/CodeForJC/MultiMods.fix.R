...
setwd("C:/Users/carrollr/OneDrive - UNC-Wilmington/Student Projects/Spring 19")

#data
databrca=read.csv("Data/BrCadat.csv")
datalbca=read.csv("Data/LBCaDat.csv")
datacrca=read.csv("Data/CRCaDat.csv")
dataprca=read.csv("Data/PrCaDat.csv")
...
write.csv(modelAFT$summary[1:97,],"C:/Users/twili/OneDrive/Documents/Classes/MAT 596/code/Results/modelsbrcalbca.csv")
...
modelAFT=bugs(data=AFTdata,inits=inits,
              c('deviance','sigma1','sigma2',
                ...
                'beta1','beta2','D1','D2'),
              bugs.directory="C:\\Users\\carrollr\\Documents\\WinBUGS14\\",
              n.chains=2,n.iter=15000,n.burnin=13000,debug=T,
              model.file="C:\\Users\\carrollr\\OneDrive - UNC-Wilmington\\Student Projects\\Spring 19\\Code\\STbrcalbca.txt")
...
modelAFT=bugs(data=AFTdata,inits=inits,
              ...
              bugs.directory="C:\\Users\\carrollr\\Documents\\WinBUGS14\\",
              n.chains=2,n.iter=18000,n.burnin=16000,debug=T,
              model.file="C:\\Users\\carrollr\\OneDrive - UNC-Wilmington\\Student Projects\\Spring 19\\Code\\STbrcacrcaprca.txt")
